class 随心绘 {
    ...
    this.canvas.addEventListener("mousemove", (e) => {
      ...
      if (this.全局属性.已选中基础形状 === "选择路径") {
        ...
        if (this.交互框) {
          ...
          if (this.全局标志.拖拽中) {
          ...
          } else if (this.全局标志.旋转中 || this.交互框.鼠标位于边界) {
            const 位于旋转句柄 =
            ...
            if (this.全局标志.旋转中) {
              ...
              if (this.全局属性.选中形状.形状 === "矩形") {
                ...
                this.全局属性.选中形状.起始弧度 = this.全局属性.选中形状.点击时起始弧度 - 弧度差;
                this.全局属性.选中形状.极值坐标 = this.获取极值坐标(this.全局属性.选中形状);
  ...
  获取极值坐标(形状对象) {
    ...
    if (
      ...
      极值坐标.上 = 形状对象.坐标.y - 形状对象.垂直半径;
      极值坐标.下 = 形状对象.坐标.y + 形状对象.垂直半径;
      极值坐标.左 = 形状对象.坐标.x - 形状对象.水平半径;
      极值坐标.右 = 形状对象.坐标.x + 形状对象.水平半径;
      极值坐标.中心 = {
        x: 形状对象.坐标.x,
        y: 形状对象.坐标.y,
      };
