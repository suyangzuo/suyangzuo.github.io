class 链表可视化 {
  ...
  生成随机姓名() {
    ...
    const 名字 = [
      ...
      // 建国初期特色名字（50-70年代）
      "建国", "建军", "建平", "建强", "建明", "建新", "建伟", "建英", "建珍", "建芳",
      "志强", "志明", "志新", "志伟", "志平", "志华", "志英", "志珍", "志芳", "志兰",
      "国强", "国明", "国新", "国伟", "国平", "国华", "国英", "国珍", "国芳", "国兰",
      "家强", "家明", "家新", "家伟", "家平", "家华", "家英", "家珍", "家芳", "家兰",
      "文强", "文明", "文新", "文伟", "文平", "文华", "文英", "文珍", "文芳", "文兰",
      "玉华", "玉英", "玉珍", "玉芳", "玉兰", "秀华", "秀英", "秀珍", "秀芳", "秀兰",
      "美华", "美英", "美珍", "美芳", "美兰", "丽华", "丽英", "丽珍", "丽芳", "丽兰",
      ...
      // 现代流行名字（10年代至今）
      "子墨", "子轩", "子涵", "子萱", "子琪", "子瑶", "子欣", "子鑫", "子磊", "子鹏",
      "梓墨", "梓轩", "梓涵", "梓萱", "梓琪", "梓瑶", "梓欣", "梓鑫", "梓磊", "梓鹏",
      "浩然", "浩宇", "浩天", "浩博", "浩轩", "浩涵", "浩萱", "浩琪", "浩瑶", "浩欣",
      "博文", "博雅", "博学", "博识", "博闻", "博见", "博爱", "博学", "博雅", "博文"
    ];
