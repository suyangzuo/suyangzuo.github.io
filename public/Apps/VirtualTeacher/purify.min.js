...
!(function (e, t) {
  ...
  var V = (function t() {
    ...
    const o = (e) => t(e);
    if (((o.version = "3.0.6"), (o.removed = []), !n || !n.document || 9 !== n.document.nodeType))
    ...
    let Q,
      ee = "";
    const { implementation: te, createNodeIterator: ne, createDocumentFragment: oe, getElementsByTagName: re } = r,
      { importNode: ie } = a;
    let ae = {};
      ...
      it = function () {
        ...
        if (!nt || nt !== e) {
          if (
            ...
            ($e = "ALLOWED_NAMESPACES" in e ? b({}, e.ALLOWED_NAMESPACES, d) : Ze),
            (Ge = "ADD_URI_SAFE_ATTR" in e ? b(S(Ye), e.ADD_URI_SAFE_ATTR, tt) : Ye),
            (Be = "ADD_DATA_URI_TAGS" in e ? b(S(We), e.ADD_DATA_URI_TAGS, tt) : We),
            ...
            e.CUSTOM_ELEMENT_HANDLING &&
              ...
              (Ee.attributeNameCheck = e.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),
            e.CUSTOM_ELEMENT_HANDLING &&
              "boolean" == typeof e.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements &&
              (Ee.allowCustomizedBuiltInElements = e.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),
            we && (be = !1),
            ke && (xe = !0),
            Fe &&
              ((he = b({}, [...C])),
            ...
            e.FORBID_CONTENTS && (He === ze && (He = S(He)), b(He, e.FORBID_CONTENTS, tt)),
            Ue && (he["#text"] = !0),
    ...
    const mt = function (e) {
        ...
        return (
          ...
          (e.namespaceURI === qe
            ...
            ? t.namespaceURI === Xe
              ...
              : Boolean(ut[n])
            : e.namespaceURI === Xe
            ? !(t.namespaceURI === qe && !lt[o]) && !(t.namespaceURI === je && !at[o]) && !ut[n] && (ct[n] || !st[n])
      ...
      dt = function (e) {
        ...
        return (
          ...
          Ke === Xe ? re.call(t, De ? "html" : "body")[0] : De ? t.documentElement : i
        );
      },
      ht = function (e) {
      ...
      Et = function (e) {
        ...
        if (
          ...
          e.hasChildNodes() && !Tt(e.firstElementChild) && E(/<[/\w]/g, e.innerHTML) && E(/<[/\w]/g, e.textContent))
        )
          return ft(e), !0;
        if (!he[n] || Ae[n]) {
          if (!Ae[n] && _t(n)) {
        ...
        return e instanceof P && !mt(e)
          ? (ft(e), !0)
          : ("noscript" !== n && "noembed" !== n && "noframes" !== n) || !E(/<\/no(script|embed|frames)/i, e.innerHTML)
          ? (we &&
              3 === e.nodeType &&
              ((t = e.textContent),
              u([le, ce, se], (e) => {
          ...
          if (
            !(
              (_t(e) &&
                ...
                ((Ee.attributeNameCheck instanceof RegExp && E(Ee.attributeNameCheck, t)) ||
                  (Ee.attributeNameCheck instanceof Function && Ee.attributeNameCheck(t)))) ||
              ("is" === t &&
        ...
        for (; r--; ) {
          ...
          if (At(p, s, f)) {
            if (
              ...
              Q && "object" == typeof G && "function" == typeof G.getAttributeType)
            )
              if (l);
              else
      ...
      bt = function e(t) {
        ...
        for (yt("beforeSanitizeShadowDOM", t, null); (n = o.nextNode()); )
          yt("uponSanitizeShadowNode", n, null), Et(n) || (n.content instanceof s && e(n.content), Nt(n));
    ...
    return (
      (o.sanitize = function (e) {
        ...
        if (Pe) return e;
        if (xe) {
          if (ke) for (l = oe.call(n.ownerDocument); n.firstChild; ) l.appendChild(n.firstChild);
          else l = n;
