  ...
  var ye = (l, e) => {
    ...
    Re = (l, e, t, n) => {
      if ((e && typeof e == "object") || typeof e == "function")
        for (let s of Te(e))
          !we.call(l, s) && s !== t && H(l, s, { get: () => e[s], enumerable: !(n = be(e, s)) || n.enumerable });
      return l;
    };
...
${u}`
          ...
          if (
            ((this.lexer.state.top = !0), this.lexer.blockTokens(u, r, !0), (this.lexer.state.top = d), n.length === 0)
          )
            break;
          let g = r.at(-1);
          ...
          ? e.tokens[0]?.type === "paragraph"
            ? ((e.tokens[0].text = n + " " + e.tokens[0].text),
              e.tokens[0].tokens &&
                ...
                ((e.tokens[0].tokens[0].text = n + " " + R(e.tokens[0].tokens[0].text)),
  ...
  var E = class {
    ...
    parseMarkdown(e) {
      return (n, s) => {
        ...
        if (typeof n != "string")
          return o(
            new Error("marked(): input parameter is of type " + Object.prototype.toString.call(n) + ", string expected")
          );
