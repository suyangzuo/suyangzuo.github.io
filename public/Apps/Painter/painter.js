        ...
        if (
          ...
          this.全局属性.多选旋转初始位置组.forEach((初始位置) => {
            ...
            if (形状.形状 === "矩形" || 形状.形状 === "图像" || 形状.形状 === "箭头") {
              ...
              // 从顶点坐标组反推坐标（左边中心点）
              const 中心x =
                (形状.顶点坐标组[0].x + 形状.顶点坐标组[1].x + 
                 形状.顶点坐标组[2].x + 形状.顶点坐标组[3].x) / 4;
              const 中心y =
                (形状.顶点坐标组[0].y + 形状.顶点坐标组[1].y + 
                 形状.顶点坐标组[2].y + 形状.顶点坐标组[3].y) / 4;
              ...
              if (形状.旋转弧度) {
                ...
                实际宽度 = Math.max(...形状.顶点坐标组.map((v) => v.x)) - 
                          Math.min(...形状.顶点坐标组.map((v) => v.x));
              }
          ...
          if (this.全局标志.拖拽中) {
            ...
            if (
              ...
              if (this.全局属性.选中形状.形状 === "文本" && this.全局属性.选中形状.按下时顶点坐标组) {
                ...
                // 从顶点坐标组反推坐标（左边中心点）
                const 中心x =
                  (this.全局属性.选中形状.顶点坐标组[0].x + this.全局属性.选中形状.顶点坐标组[1].x + 
                   this.全局属性.选中形状.顶点坐标组[2].x + this.全局属性.选中形状.顶点坐标组[3].x) / 4;
                const 中心y =
                  (this.全局属性.选中形状.顶点坐标组[0].y + this.全局属性.选中形状.顶点坐标组[1].y + 
                   this.全局属性.选中形状.顶点坐标组[2].y + this.全局属性.选中形状.顶点坐标组[3].y) / 4;
                ...
                if (this.全局属性.选中形状.旋转弧度) {
                  ...
                  实际宽度 = Math.max(...this.全局属性.选中形状.顶点坐标组.map((v) => v.x)) - 
  ...
  应用缩放(形状对象, 水平缩放比例, 垂直缩放比例, 缩放锚点) {
    if (形状对象.形状 === "文本") {
      ...
      if (形状对象.旋转弧度) {
        ...
        实际宽度 = Math.max(...形状对象.顶点坐标组.map((v) => v.x)) - 
                  Math.min(...形状对象.顶点坐标组.map((v) => v.x));
      }
